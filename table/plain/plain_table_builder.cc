...
IOStatus WriteBlock(const Slice& block_contents, AbstractWritableFileWriter* file,
...
PlainTableBuilder::PlainTableBuilder(
    ...
    uint32_t column_family_id, int level_at_creation, AbstractWritableFileWriter* file,
