...
class LastLevelTableIterator : public InternalIteratorBase<Slice> {
  // compaction_readahead_size: its value will only be used if for_compaction =
  // true
  // @param read_options Must outlive this iterator.
 public:
  LastLevelTableIterator(
      const LastLevelTableReader* table, const ReadOptions& read_options,
  ...
  bool PrepareValue() override {
    ...
    return false; //Tarim-TODO:
    //return const_cast<LastLevelTableIterator*>(this)
 ...
 private:
  ...
  const LastLevelTableReader* table_;
  const ReadOptions& read_options_;
  const InternalKeyComparator& icomp_;
  UserComparatorWrapper user_comparator_;
  PinnedIteratorsManager* pinned_iters_mgr_;
  DataBlockIter block_iter_; //Tarim-TODO:
